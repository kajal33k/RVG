        ...
        <div id="jewellery" class="tab-pane flex flex-col lg:flex-row gap-6 p-8 hidden">
            ...
            <div class="w-full lg:w-9/12 relative slider-container">
                <div id="slider-jewellery" class="slider-wrapper">
                    <img src="{{ asset('assets/img/attendence.jpg') }}" loading="lazy" alt="Jewellery Slide 1" class="slider-image">
                    <img src="{{ asset('assets/img/attendence.jpg') }}" loading="lazy" alt="Jewellery Slide 2" class="slider-image">
                    <img src="{{ asset('assets/img/attendence.jpg') }}" loading="lazy" alt="Jewellery Slide 3" class="slider-image">
                    <img src="{{ asset('assets/img/attendence.jpg') }}" loading="lazy" alt="Jewellery Slide 4" class="slider-image">
                </div>
        ...
        <div id="cakes" class="tab-pane flex flex-col lg:flex-row gap-6 p-8 hidden">
            ...
            <div class="w-full lg:w-9/12 relative slider-container">
                <div id="slider-cakes" class="slider-wrapper">
                    <img src="{{ asset('assets/img/category/cakes/1.jpg') }}" loading="lazy" alt="Cakes Slide 1" class="slider-image">
                    <img src="{{ asset('assets/img/category/cakes/2.jpg') }}" loading="lazy" alt="Cakes Slide 2" class="slider-image">
                    <img src="{{ asset('assets/img/category/cakes/3.jpg') }}" loading="lazy" alt="Cakes Slide 3" class="slider-image">
                    <img src="{{ asset('assets/img/category/cakes/4.jpg') }}" loading="lazy" alt="Cakes Slide 4" class="slider-image">
                </div>
