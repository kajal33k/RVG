...
<div class="container mx-auto px-4 py-10 sm:py-20">
    ...
    <div id="tab-content" class="bg-white shadow-2xl rounded-3xl overflow-hidden">
        ...
        <div id="restaurant" class="tab-pane flex flex-col lg:flex-row gap-6 p-8 hidden">
            ...
            <div class="w-full lg:w-9/12 relative slider-container">
                <div id="slider-restaurant" class="slider-wrapper">
                    <img src="{{ asset('assets/img/category/restaurant/1.jpg') }}" alt="restaurant Slide 1"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/restaurant/2.jpg') }}" alt="restaurant Slide 2"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/restaurant/3.jpg') }}" alt="restaurant Slide 3"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/restaurant/4.jpg') }}" alt="restaurant Slide 4"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/restaurant/5.jpg') }}" alt="restaurant Slide 5"
                        class="slider-image">
                </div>
        ...
        <div id="hospital" class="tab-pane flex flex-col lg:flex-row gap-6 p-8 hidden">
            ...
            <div class="w-full lg:w-9/12 relative slider-container">
                <div id="slider-hospital" class="slider-wrapper">
                    <img src="{{ asset('assets/img/category/hospital/1.jpg') }}" alt="hospital Slide 1"
                        class="slider-image">
                    ...
                    <img src="{{ asset('assets/img/category/hospital/3.jpg') }}" alt="hospital Slide 3"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/hospital/4.jpg') }}" alt="hospital Slide 4"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/hospital/5.jpg') }}" alt="hospital Slide 5"
                        class="slider-image">
                </div>
        ...
        <div id="dentist" class="tab-pane flex flex-col lg:flex-row gap-6 p-8 hidden">
            ...
            <div class="w-full lg:w-9/12 relative slider-container">
                <div id="slider-dentist" class="slider-wrapper">
                    <img src="{{ asset('assets/img/category/dentist/1.jpg') }}" alt="dentist Slide 1"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/dentist/2.jpg') }}" alt="dentist Slide 2"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/dentist/3.jpg') }}" alt="dentist Slide 3"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/dentist/4.jpg') }}" alt="dentist Slide 4"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/dentist/5.jpg') }}" alt="dentist Slide 5"
                        class="slider-image">
                </div>
            ...
            <div class="w-full lg:w-9/12 relative slider-container">
                <div id="slider-parlour" class="slider-wrapper">
                    ...
                    <img src="{{ asset('assets/img/category/parlour/3.jpg') }}" alt="parlour Slide 3"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/parlour/4.jpg') }}" alt="parlour Slide 4"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/parlour/5.jpg') }}" alt="parlour Slide 5"
                        class="slider-image">
                </div>
            ...
            <div class="w-full lg:w-9/12 relative slider-container">
                <div id="slider-solar" class="slider-wrapper">
                    ...
                    <img src="{{ asset('assets/img/category/solar/3.jpg') }}" alt="solar Slide 3"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/solar/4.jpg') }}" alt="solar Slide 4"
                        class="slider-image">
                    <img src="{{ asset('assets/img/category/solar/5.jpg') }}" alt="solar Slide 5"
                        class="slider-image">
                </div>
        ...
        <!-- Cakes Design Tab -->
        <div id="cakes" class="tab-pane flex flex-col lg:flex-row gap-6 p-8">
            <!-- Left Section -->
            <div class="w-full lg:w-4/12 bg-gradient-to-br from-gray-50 to-gray-100 p-10 rounded-2xl shadow-lg">
                <h2
                    class="text-2xl sm:text-3xl font-bold mb-6 text-gray-900 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-blue-600">
    ...
    <div class="flex justify-center mt-8">
        <a href="#" class="px-6 py-3 text-white font-semibold bg-red-500 rounded-lg shadow-md transition-all duration-300 hover:bg-red-600 hover:shadow-lg hover:-translate-y-1 active:translate-y-1">
            View More
        </a>
    </div>
