    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 pt-8 border-t border-white/50">
            <div class="flex flex-wrap justify-center gap-8">
                ...
                <a href="{{ route('frontend.contact') }}"
                    class="text-sm text-gray-200 hover:text-white transition-colors duration-300">Contact Us</a>
        ...
        <div class="mt-12 pt-8 border-t border-white/50">
            <div class="flex flex-col sm:flex-row items-center justify-between">
                ...
                <div>
                    <a href="{{ route('frontend.privacy.policy') }}"
                        class="text-sm text-gray-200 hover:text-white transition-colors duration-300">
                        Privacy Policy
                    </a>
